...
const STEPS = ['Jadwal', 'Pekerja & Barang', 'Detail', 'Review'];
            ...
            <div className="px-6 sm:px-8 py-6 flex-1">
                ...
                <form onSubmit={submit}>
                    <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-6 items-start">
                                            ...
                                            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                                                ...
                                                {data.is_external && (
                                                    <>
                                                        ...
                                                        <ReviewRow label="Alamat Vendor" value={data.contractor_address || '—'} className="sm:col-span-2" />
                                                    </>
                                                )}
                                                <ReviewRow
                                                    label="Pendampingan"
                        ...
                        {/* Kolom kanan — ringkasan hidup */}
                        <div className="lg:sticky lg:top-[72px]">
                            <LiveSummary data={data} currentStep={step} />
                        </div>
                    </div>
                </form>
                ...
                >
                    ...
                    <ConfirmRow label="Vendor" value={data.is_external ? (data.contractor_company || 'Ya') : 'Tidak'} />
                </ConfirmModal>
            </div>
        </PortalLayout>
    );
...
function LiveSummary({ data, currentStep }) {
        ...
        <div className="bg-white rounded-xl border border-[#E2E5EA] p-5">
            ...
            <div className="space-y-3">
                ...
                <SummaryItem
                    ...
                    value={data.is_external ? 'Ya' : 'Tidak'}
                    filled
                    dim={currentStep < 3}
                />
                <SummaryItem
